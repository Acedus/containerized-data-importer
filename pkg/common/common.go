...
const (
	...
	// ImporterRegistryImageLayerMatchAnnotations provides a constant to capture our env variable "IMPORTER_REGISTRY_IMAGE_LAYER_MATCH_ANNOTATIONS"
	ImporterRegistryImageLayerMatchAnnotations = "IMPORTER_REGISTRY_IMAGE_LAYER_MATCH_ANNOTATIONS"
