...
func NewRegistryDataSource(endpoint, accessKey, secKey, imageArchitecture, layerDigest, certDir string, insecureTLS bool) *RegistryDataSource {
...
func (rd *RegistryDataSource) Transfer(path string, preallocation bool) (ProcessingPhase, error) {
	...
	rd.info, err = CopyRegistryImage(rd.endpoint, path, containerDiskImageDir, rd.accessKey, rd.secKey, rd.imageArchitecture, rd.layerDigest, rd.certDir, rd.insecureTLS, preallocation)
	if err != nil {
