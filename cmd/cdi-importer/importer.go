...
func newDataSource(source string, contentType string, volumeMode v1.PersistentVolumeMode) importer.DataSourceInterface {
	...
	registryLayerDigest, _ := util.ParseEnvVar(common.ImporterRegistryLayerDigest, false)
	...
	case cc.SourceRegistry:
		ds := importer.NewRegistryDataSource(ep, acc, sec, registryImageArchitecture, registryLayerDigest, certDir, insecureTLS)
		return ds
	case cc.SourceS3:
